            ...
            <div class="card-body">
                <h5 class="card-title">
                    ...
                    <?php if(Auth::user()->roles_label[0] == 'SuperAdmin'): ?>
                        <a href="<?php echo e(route('satuan.create')); ?>" class="btn btn-sm btn-outline-success">
                            ...
                            <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if(Auth::user()->roles_label[0] == 'SuperAdmin'): ?>
                                            <form action="<?php echo e(route('satuan.delete', $item->id)); ?>" method="post">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('delete'); ?>
                                                <a href="<?php echo e(route('satuan.edit', $item->id)); ?>"
...
<?php echo $__env->make('layouts.template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\elnusa-inventory\resources\views/pages/atributBarang/unit/index.blade.php ENDPATH**/ ?>