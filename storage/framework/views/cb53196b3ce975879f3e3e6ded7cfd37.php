            ...
            <div class="card-body">
                <h5 class="card-title">
                    ...
                    <?php if(Auth::user()->roles_label[0] == 'SuperAdmin'): ?>
                        <a href="<?php echo e(route('supplier.create')); ?>" class="btn btn-sm btn-outline-success">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($item->register_date); ?></td>
                                    <td><?php echo e($item->address); ?></td>
                                    <td><?php echo e($item->telp); ?></td>
                                    <td class="text-center">
                                        <?php if(Auth::user()->roles_label[0] == 'SuperAdmin'): ?>
                                            <form action="<?php echo e(route('supplier.delete', $item->id)); ?>" method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\elnusa-inventory\resources\views/pages/masterData/supplier/index.blade.php ENDPATH**/ ?>