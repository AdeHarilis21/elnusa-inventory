    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3 mb-4" action="<?php echo e(route('report.stockOut')); ?>" method="GET">
                    <div class="col-6">
                    ...
                    <div class="text-left">
                        ...
                        <a href="<?php echo e(route('report.stockOut')); ?>" class="btn btn-secondary">Reset Filter</a>
                    </div>
                </form>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($item->stock->attn); ?></td>
                                    <td><?php echo e($item->stock->via); ?></td>
                                    <td><?php echo e($item->stock->carrier); ?></td>
                                    <td><?php echo e($item->stock->reff); ?></td>
                                    <td><?php echo e($item->stock->truck_no); ?></td>
                                    <td><?php echo e($item->stock->delivered_by); ?></td>
                                </tr>
...
<?php echo $__env->make('layouts.template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\elnusa-inventory\resources\views/pages/stock/report/stockOut.blade.php ENDPATH**/ ?>