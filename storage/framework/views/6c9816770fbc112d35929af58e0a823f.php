            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            List Barang Masuk
                            <a href="<?php echo e(route('masuk.index')); ?>" class="btn btn-sm btn-outline-secondary m-2">Kembali</a>
                        </h5>
...
<?php echo $__env->make('layouts.template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\elnusa-inventory\resources\views/pages/stock/stockIn/detail.blade.php ENDPATH**/ ?>